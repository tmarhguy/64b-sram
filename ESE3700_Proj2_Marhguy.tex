...
Top-level $t_{\mathrm{CLK}\to D_{out}}$ (single-edge access) & 110.65\,ps & \texttt{media/terminal/final-top-final-terminal-out.png} \\
Top-level $I_{DD,\mathrm{avg}}$ / $P_{\mathrm{avg}}$ & 21.367\,\textmu A / 21.367\,\textmu W & \texttt{media/terminal/final-top-final-terminal-out.png} \\
Top-level readback @ 5\,ns / @ 7\,ns & $\mathtt{0x5}$ / $\mathtt{0xA}$ (PASS) & \texttt{media/terminal/final-top-final-terminal-out.png} \\
Delay-derived equivalent frequency $f_{eq}=1/t_{\mathrm{CLK}\to D_{out}}$ & 9.037\,GHz @ 110.65\,ps & \texttt{media/terminal/final-top-final-terminal-out.png} \\
